...
class File:
    def __init__(self,unique_id,file_name,file_url,course_id,upload_time,spare1,spare2,spare3,spare4):
    ...
    def insert(self):
        ...
        mysql="insert into file(unique_id,file_name,file_url,course_id,upload_time,spare1,spare2,spare3,spare4)" \
              ...
              %(self.unique_id,self.file_name,self.file_url,self.course_id,self.upload_time,self.spare1,self.spare2,self.spare3,self.spare4)
        try:
        # 执行sql语句
    ...
    def update(self):
        ...
        spare3='%s',spare4='%s' where unique_id='%s'" %(self.file_name,self.file_url,self.course_id,self.upload_time,
    ...
    def queryByid(self,id):
        db=DB()
        cursor=db.connection()
        mysql="select * from file where unique_id='%s'" %(id)
        result=None
        try:
            cursor.execute(mysql)
